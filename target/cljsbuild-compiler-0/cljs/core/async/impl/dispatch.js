...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13754 = (0);while(true){
var m_13755 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13755 == null))
{} else
{m_13755.call(null);
if((count_13754 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13756 = (count_13754 + (1));
count_13754 = G__13756;
continue;
}
} else
{}
