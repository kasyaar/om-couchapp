...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13760 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13760 = (function (val,box,meta13761){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13760.cljs$lang$type = true;
cljs.core.async.impl.channels.t13760.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13760";
cljs.core.async.impl.channels.t13760.cljs$lang$ctorPrWriter = (function (this__4120__auto__,writer__4121__auto__,opt__4122__auto__){return cljs.core._write.call(null,writer__4121__auto__,"cljs.core.async.impl.channels/t13760");
});
cljs.core.async.impl.channels.t13760.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13760.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13762){var self__ = this;
var _13762__$1 = this;return self__.meta13761;
});
cljs.core.async.impl.channels.t13760.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13762,meta13761__$1){var self__ = this;
var _13762__$1 = this;return (new cljs.core.async.impl.channels.t13760(self__.val,self__.box,meta13761__$1));
});
cljs.core.async.impl.channels.__GT_t13760 = (function __GT_t13760(val__$1,box__$1,meta13761){return (new cljs.core.async.impl.channels.t13760(val__$1,box__$1,meta13761));
});
}
return (new cljs.core.async.impl.channels.t13760(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13763 = self__.takes.pop();if((taker_13763 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13763))
{var take_cb_13764 = cljs.core.async.impl.protocols.commit.call(null,taker_13763);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13764,taker_13763,this$__$1){
return (function (){return take_cb_13764.call(null,null);
});})(take_cb_13764,taker_13763,this$__$1))
);
} else
{}
{
