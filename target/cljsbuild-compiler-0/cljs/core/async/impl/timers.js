...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13661 = (0);while(true){
if((i_13661 < arr.length))
{(arr[i_13661] = null);
{
var G__13662 = (i_13661 + (1));
i_13661 = G__13662;
continue;
}
} else
...
{var i_13668 = (self__.level + (1));while(true){
if((i_13668 <= (new_level + (1))))
{(update[i_13668] = self__.header);
{
var G__13669 = (i_13668 + (1));
i_13668 = G__13669;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13670 = (0);while(true){
if((i_13670 <= self__.level))
{var links_13671 = (update[i_13670]).forward;if(((links_13671[i_13670]) === x__$1))
{(links_13671[i_13670] = (x__$1.forward[i_13670]));
{
